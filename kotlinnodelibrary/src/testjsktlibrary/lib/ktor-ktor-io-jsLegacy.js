(function (root, factory) {
          ...
          case 0:
            if (this.$this.closedCause != null) {
              ...
              if (this.$this.readable.canRead()) {
                ...
                if (this.$this.closed) {
                  return this.$this.readAvailableClosed();
                } else {
  ...
  Coroutine$readAvailableSuspend_b4eait$_0.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$readAvailableSuspend_v6ah9b$_0.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Object.defineProperty(AbstractInput.prototype, 'headRemaining', {configurable: true, get: defineInlineFunction('ktor-ktor-io-jsLegacy.io.ktor.utils.io.core.AbstractInput.get_headRemaining', function () {
  ...
  Object.defineProperty(AbstractOutput.prototype, 'tailRemaining_8be2vx$', {configurable: true, get: defineInlineFunction('ktor-ktor-io-jsLegacy.io.ktor.utils.io.core.AbstractOutput.get_tailRemaining_8be2vx$', function () {
  ...
  Object.defineProperty(Buffer.prototype, 'endGap', {configurable: true, get: defineInlineFunction('ktor-ktor-io-jsLegacy.io.ktor.utils.io.core.Buffer.get_endGap', function () {
    return this.capacity - this.limit | 0;
  })});
  Object.defineProperty(Buffer.prototype, 'readRemaining', {configurable: true, get: defineInlineFunction('ktor-ktor-io-jsLegacy.io.ktor.utils.io.core.Buffer.get_readRemaining', function () {
    return this.writePosition - this.readPosition | 0;
  })});
  Object.defineProperty(Buffer.prototype, 'writeRemaining', {configurable: true, get: defineInlineFunction('ktor-ktor-io-jsLegacy.io.ktor.utils.io.core.Buffer.get_writeRemaining', function () {
  ...
  Object.defineProperty(EncodeResult.prototype, 'characters', {configurable: true, get: defineInlineFunction('ktor-ktor-io-jsLegacy.io.ktor.utils.io.core.internal.EncodeResult.get_characters', wrapFunction(function () {
    var toShort = Kotlin.toShort;
    var UShort_init = Kotlin.kotlin.UShort;
    return function () {
  ...
  Object.defineProperty(EncodeResult.prototype, 'bytes', {configurable: true, get: defineInlineFunction('ktor-ktor-io-jsLegacy.io.ktor.utils.io.core.internal.EncodeResult.get_bytes', wrapFunction(function () {
    var toShort = Kotlin.toShort;
    var UShort_init = Kotlin.kotlin.UShort;
    return function () {
  ...
  function checkPeekTo(destination, offset, min, max) {
    if (!(offset >= 0)) {
      var m = new require$ObjectLiteral_8(checkPeekTo$lambda(offset));
      m.doFail();
    }if (!(min >= 0)) {
      var m_0 = new require$ObjectLiteral_8(checkPeekTo$lambda_0(min));
      m_0.doFail();
    }if (!(max >= min)) {
      var m_1 = new require$ObjectLiteral_8(checkPeekTo$lambda_1(max, min));
      m_1.doFail();
    }if (!(min <= (destination.limit - destination.writePosition | 0))) {
      var m_2 = new require$ObjectLiteral_8(checkPeekTo$lambda_2(min, destination));
      m_2.doFail();
    }}
  ...
  function ByteChannelJS$attachJob$lambda(this$ByteChannelJS) {
    return function (cause) {
      ...
      if (cause != null) {
        this$ByteChannelJS.cancel_dbl4no$(cause);
      }return Unit;
    };
  }
  ...
  Object.defineProperty(Memory.prototype, 'size', {configurable: true, get: defineInlineFunction('ktor-ktor-io-jsLegacy.io.ktor.utils.io.bits.Memory.get_size', function () {
    return Kotlin.Long.fromInt(this.view.byteLength);
  })});
  Object.defineProperty(Memory.prototype, 'size32', {configurable: true, get: defineInlineFunction('ktor-ktor-io-jsLegacy.io.ktor.utils.io.bits.Memory.get_size32', function () {
  ...
  function readFully_33($receiver, dst, offset, length) {
    if (!(length <= dst.byteLength)) {
      var m = new require$ObjectLiteral_9(readFully$lambda(length, dst));
      m.doFail();
  ...
  require$ObjectLiteral_10.prototype.constructor = require$ObjectLiteral_10;
  function require$ObjectLiteral_10(closure$message) {
    this.closure$message = closure$message;
    RequireFailureCapture.call(this);
  }
  require$ObjectLiteral_10.prototype.doFail = function () {
    throw IllegalArgumentException_init(this.closure$message());
  };
  require$ObjectLiteral_10.$metadata$ = {kind: Kind_CLASS, interfaces: [RequireFailureCapture]};
  ...
  IoBuffer.prototype.readFully_p0d4q1$ = function (dst, offset, length) {
    ...
    if (!(offset >= 0)) {
      var m = new require$ObjectLiteral_10(IoBuffer$readFully$lambda);
      m.doFail();
    }if (!((offset + length | 0) <= dst.byteLength)) {
      var m_0 = new require$ObjectLiteral_10(IoBuffer$readFully$lambda_0);
      m_0.doFail();
  ...
  IoBuffer$Companion$Pool$ObjectLiteral.prototype.validateInstance_trkh7z$ = function (instance) {
    DefaultPool.prototype.validateInstance_trkh7z$.call(this, instance);
    if (!(instance.referenceCount === 0)) {
      var m = new require$ObjectLiteral_10(IoBuffer$Companion$Pool$ObjectLiteral$validateInstance$lambda(instance));
      m.doFail();
    }if (!(instance.origin == null)) {
      var m_0 = new require$ObjectLiteral_10(IoBuffer$Companion$Pool$ObjectLiteral$validateInstance$lambda_0);
      m_0.doFail();
    }};
  ...
  function TextDecoderFatal(encoding, fatal) {
    if (fatal === void 0)
      fatal = true;
    if (IS_NODE || typeof TextDecoder == 'undefined') {
  ...
  var tmp$;
  IS_NODE = typeof (tmp$ = (typeof process !== 'undefined' && process.versions != null && process.versions.node != null)) === 'boolean' ? tmp$ : throwCCE();
...
//# sourceMappingURL=ktor-ktor-io-jsLegacy.js.map

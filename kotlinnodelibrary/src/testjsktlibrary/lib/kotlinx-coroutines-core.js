(function (root, factory) {
  ...
  var startCoroutine = Kotlin.kotlin.coroutines.startCoroutine_3a617i$;
  ...
  function withContext$lambda(closure$context, closure$block) {
    return function (uCont) {
      ...
      coroutine_1.start_b5ul0p$(CoroutineStart$DEFAULT_getInstance(), coroutine_1, closure$block);
  ...
  function startCoroutineImpl(start, receiver, completion, onCancellation, block) {
    switch (start.name) {
      case 'DEFAULT':
        startCoroutineCancellable_0(block, receiver, completion, onCancellation);
        break;
      case 'ATOMIC':
  ...
  function LazyStandaloneCoroutine(parentContext, block) {
    ...
    this.saved_0 = createCoroutineUnintercepted(block, this, this);
  }
  LazyStandaloneCoroutine.prototype.onStart = function () {
    var tmp$;
    startCoroutineCancellable_1(Kotlin.isType(tmp$ = this.saved_0, Continuation) ? tmp$ : throwCCE(), this);
  };
  ...
  DispatchedCoroutine.prototype.afterResume_s8jyv4$ = function (state) {
    if (this.tryResume_0())
      return;
    var $receiver = this.uCont;
    var result = recoverResult(state, this.uCont);
    resumeCancellableWith(intercepted($receiver), result);
  };
  ...
  function getOrCreateCancellableContinuation(delegate) {
    var tmp$, tmp$_0;
    if (!true || !Kotlin.isType(delegate, DispatchedContinuation)) {
  ...
  Object.defineProperty(CancellableContinuationImpl.prototype, 'delegate', {configurable: true, get: function () {
  ...
  CancellableContinuationImpl.prototype.isReusable_0 = function () {
    var tmp$ = Kotlin.isType(this.delegate, DispatchedContinuation) && this.delegate.isReusable_pmw987$(this);
    if (tmp$) {
      tmp$ = true;
    }return tmp$;
  };
  ...
  CancellableContinuationImpl.prototype.parentCancelled_mmkme6$ = function (parentJob) {
    var cause = this.getContinuationCancellationCause_dqr1mp$(parentJob);
  ...
  CancellableContinuationImpl.prototype.resumeUndispatched_hyuxa3$ = function ($receiver, value) {
    var tmp$;
    var dc = Kotlin.isType(tmp$ = asLocalOrNullIfNotUsed(this.delegate), DispatchedContinuation) ? tmp$ : null;
  ...
  function CompletedContinuation(result, cancelHandler, onCancellation, idempotentResume, cancelCause) {
    ...
    this._cancelHandler_0 = cancelHandler;
    this._onCancellation_0 = onCancellation;
  }
  Object.defineProperty(CompletedContinuation.prototype, 'cancelHandler', {configurable: true, get: function () {
    return this._cancelHandler_0;
  }});
  Object.defineProperty(CompletedContinuation.prototype, 'onCancellation', {configurable: true, get: function () {
  ...
  CompletedContinuation.prototype.releaseHandlers = function () {
    this._cancelHandler_0 = null;
    this._onCancellation_0 = null;
  };
  ...
  CompletedContinuation.prototype.copy_pkdjca$ = function (result, cancelHandler, onCancellation, idempotentResume, cancelCause) {
    ...
    if (idempotentResume === void 0)
      idempotentResume = this.idempotentResume;
    if (cancelCause === void 0)
  ...
  JobSupport$Finishing.prototype.sealLocked_dbl4no$ = function (proposedException) {
    ...
    if (rootCause != null) {
      list.v.add_wxm5ur$(0, rootCause);
    }if (proposedException != null && !equals(proposedException, rootCause)) {
      list.v.add_11rb$(proposedException);
  ...
  function JobImpl(parent) {
    ...
    this.handlesException_fejgjb$_0 = this.handlesExceptionF(parent);
  ...
  JobImpl.prototype.handlesExceptionF = function (parent) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2;
    tmp$_0 = Kotlin.isType(tmp$ = parent, JobSupport) ? tmp$ : null;
    if (tmp$_0 == null) {
      return false;
    }var parentJob = tmp$_0;
    if (parentJob.handlesException)
      return true;
    return this.handlesExceptionF((tmp$_2 = Kotlin.isType(tmp$_1 = parentJob.parentHandle_8be2vx$, ChildHandleNode) ? tmp$_1 : null) != null ? tmp$_2.job : null);
  };
  ...
  ChildContinuation.prototype.invoke = function (cause) {
    this.child.parentCancelled_mmkme6$(this.job);
  };
  ...
  function dispatch($receiver, mode) {
    ...
    if (!undispatched && Kotlin.isType(local, DispatchedContinuation) && get_isCancellableMode(mode) === get_isCancellableMode($receiver.resumeMode)) {
      var dispatcher = local.dispatcher;
      ...
      while (true) {
        ...
        if (result === UNDECIDED_1) {
          ...
          if (function (scope) {
            ...
            var tmp$ = this.uCont_0;
            var result_0 = new Result(createFailure(exception));
            intercepted(tmp$).resumeWith_tl1gpc$(result_0);
            break doResume_0$break;
          }} else
          throw IllegalStateException_init('Already resumed');
      }
  ...
  SelectBuilderImpl.prototype.doAfterSelect_0 = function () {
    var parentHandle = function (scope) {
      var oldValue = scope._parentHandle_0;
      scope._parentHandle_0 = null;
      return oldValue;
    }(this);
    parentHandle != null ? (parentHandle.dispose(), Unit) : null;
    var cur = this._next;
    while (!equals(cur, this)) {
  ...
  SelectBuilderImpl$DisposeNode.prototype.dispose = function () {
    var handle = function (scope) {
      var oldValue = scope._handle_0;
      scope._handle_0 = null;
      return oldValue;
    }(this);
    handle != null ? (handle.dispose(), Unit) : null;
  };
  ...
  JobCancellationException.prototype.toString = function () {
    return CancellationException.prototype.toString.call(this) + '; job=' + toString(this.job_8be2vx$);
  };
  ...
  JobCancellationException.prototype.hashCode = function () {
    var tmp$, tmp$_0;
    var $receiver = this.job_8be2vx$;
    var tmp$_1;
    return (((hashCode(ensureNotNull(this.message)) * 31 | 0) + ((tmp$_1 = $receiver != null ? hashCode($receiver) : null) != null ? tmp$_1 : 0) | 0) * 31 | 0) + ((tmp$_0 = (tmp$ = this.cause) != null ? hashCode(tmp$) : null) != null ? tmp$_0 : 0) | 0;
  };
  ...
  function asLocalOrNullIfNotUsed($receiver) {
    return $receiver;
  }
  ...
  package$coroutines.startCoroutineImpl_f7095b$ = startCoroutineImpl;
  ...
  package$internal_0.checkOwnership_ygf9h9$ = checkOwnership;
  ...
  package$internal.DispatchedContinuation = DispatchedContinuation;
  package$internal.resumeCancellableWith_udi45l$ = resumeCancellableWith;
  ...
  package$coroutines.dispatch_3hbhhq$ = dispatch;
  package$coroutines.resume_9r8m0n$ = resume;
  ...
  package$internal.asLocalOrNullIfNotUsed_xtf5u2$ = asLocalOrNullIfNotUsed;
  package$internal.unwrap_87698k$ = unwrap;
  package$internal.CoroutineStackFrame = CoroutineStackFrame;
  package$internal.initCause_oz8fe6$ = initCause;

(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'ktor-ktor-http-jsLegacy', 'ktor-ktor-io-jsLegacy', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('ktor-ktor-http-jsLegacy'), require('ktor-ktor-io-jsLegacy'), require('kotlinx-coroutines-core'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-http-cio-jsLegacy'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'ktor-ktor-http-cio-jsLegacy'.");
    }if (typeof this['ktor-ktor-http-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-http-cio-jsLegacy'. Its dependency 'ktor-ktor-http-jsLegacy' was not found. Please, check whether 'ktor-ktor-http-jsLegacy' is loaded prior to 'ktor-ktor-http-cio-jsLegacy'.");
    }if (typeof this['ktor-ktor-io-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-http-cio-jsLegacy'. Its dependency 'ktor-ktor-io-jsLegacy' was not found. Please, check whether 'ktor-ktor-io-jsLegacy' is loaded prior to 'ktor-ktor-http-cio-jsLegacy'.");
    }if (typeof this['kotlinx-coroutines-core'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-http-cio-jsLegacy'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'ktor-ktor-http-cio-jsLegacy'.");
    }root['ktor-ktor-http-cio-jsLegacy'] = factory(typeof this['ktor-ktor-http-cio-jsLegacy'] === 'undefined' ? {} : this['ktor-ktor-http-cio-jsLegacy'], kotlin, this['ktor-ktor-http-jsLegacy'], this['ktor-ktor-io-jsLegacy'], this['kotlinx-coroutines-core']);
  }
}(this, function (_, Kotlin, $module$ktor_ktor_http_jsLegacy, $module$ktor_ktor_io_jsLegacy, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  var DefaultPool = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.pool.DefaultPool;
  var L_1 = Kotlin.Long.NEG_ONE;
  var COROUTINE_SUSPENDED = Kotlin.kotlin.coroutines.intrinsics.COROUTINE_SUSPENDED;
  var CoroutineImpl = Kotlin.kotlin.coroutines.CoroutineImpl;
  var writer = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.writer_x9a1ni$;
  var L0 = Kotlin.Long.ZERO;
  var EOFException = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.errors.EOFException;
  ...
  var ByteChannel = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.ByteChannel;
  var requestBuffer = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.requestBuffer_78elpf$;
  var Buffer = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.Buffer;
  var completeReadingFromBuffer = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.completeReadingFromBuffer_6msh3s$;
  ...
  var writeShort = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.writeShort_9kfkzl$;
...
//# sourceMappingURL=ktor-ktor-http-cio-jsLegacy.js.map

(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'ktor-ktor-io-jsLegacy', 'ktor-ktor-utils-jsLegacy', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('ktor-ktor-io-jsLegacy'), require('ktor-ktor-utils-jsLegacy'), require('kotlinx-coroutines-core'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-http-jsLegacy'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'ktor-ktor-http-jsLegacy'.");
    }if (typeof this['ktor-ktor-io-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-http-jsLegacy'. Its dependency 'ktor-ktor-io-jsLegacy' was not found. Please, check whether 'ktor-ktor-io-jsLegacy' is loaded prior to 'ktor-ktor-http-jsLegacy'.");
    }if (typeof this['ktor-ktor-utils-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-http-jsLegacy'. Its dependency 'ktor-ktor-utils-jsLegacy' was not found. Please, check whether 'ktor-ktor-utils-jsLegacy' is loaded prior to 'ktor-ktor-http-jsLegacy'.");
    }if (typeof this['kotlinx-coroutines-core'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-http-jsLegacy'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'ktor-ktor-http-jsLegacy'.");
    }root['ktor-ktor-http-jsLegacy'] = factory(typeof this['ktor-ktor-http-jsLegacy'] === 'undefined' ? {} : this['ktor-ktor-http-jsLegacy'], kotlin, this['ktor-ktor-io-jsLegacy'], this['ktor-ktor-utils-jsLegacy'], this['kotlinx-coroutines-core']);
  }
}(this, function (_, Kotlin, $module$ktor_ktor_io_jsLegacy, $module$ktor_ktor_utils_jsLegacy, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  var encode = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.charsets.encode_fj4osb$;
  ...
  var prepareReadFirstHead = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.internal.prepareReadFirstHead_j319xh$;
  var prepareReadNextHead = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.internal.prepareReadNextHead_x2nit9$;
  var completeReadHead = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.internal.completeReadHead_x2nit9$;
  ...
  var Charset = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.charsets.Charset;
  ...
  var toCharArray = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.toCharArray_pdl1vz$;
  var lastIndexOfAny = Kotlin.kotlin.text.lastIndexOfAny_junqau$;
  var removePrefix = Kotlin.kotlin.text.removePrefix_gsj5wt$;
  var caseInsensitiveMap = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.caseInsensitiveMap_287e2$;
  var asSequence = Kotlin.kotlin.collections.asSequence_7wnvza$;
  var lazy = Kotlin.kotlin.lazy_klfg04$;
  var firstOrNull = Kotlin.kotlin.collections.firstOrNull_2p1efm$;
  var IllegalArgumentException = Kotlin.kotlin.IllegalArgumentException;
  var Throwable = Error;
  var StringValues = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.StringValues;
  var StringValuesBuilder = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.StringValuesBuilder;
  var emptySet = Kotlin.kotlin.collections.emptySet_287e2$;
  var listOf_0 = Kotlin.kotlin.collections.listOf_mh5how$;
  var asList = Kotlin.kotlin.collections.asList_us0mfu$;
  var toMap_0 = Kotlin.kotlin.collections.toMap_6hr0sd$;
  var StringValuesImpl = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.StringValuesImpl;
  ...
  var isLowerCase = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.isLowerCase_myv2d0$;
  ...
  function encodeURLParameterValue$lambda$lambda(this$) {
    return function (it) {
      if (URL_ALPHABET.contains_11rb$(it) || OAUTH_SYMBOLS.contains_11rb$(it) || it === toByte(61 | 0))
        this$.append_s8itvh$(toChar(it));
      else if (it === toByte(32 | 0))
        this$.append_s8itvh$(43);
      else
        this$.append_pdl1vj$(percentEncode(it));
      return Unit;
  ...
  function encodeURLParameterValue($receiver) {
    var $receiver_0 = StringBuilder_init_0();
    var content = encode(charsets.Charsets.UTF_8.newEncoder(), $receiver);
    forEach(content, encodeURLParameterValue$lambda$lambda($receiver_0));
    return $receiver_0.toString();
  }
  ...
  ContentType.prototype.withParameter_puj7f4$ = function (name, value) {
    if (this.hasParameter_0(name, value))
      return this;
    return new ContentType(this.contentType, this.contentSubtype, this.content, plus_2(this.parameters, new HeaderValueParam(name, value)));
  };
    ...
    if (this.parameters.isEmpty())
      ...
      for (var index = 0; index < tmp$_1; index++) {
        ...
        if (checkNeedEscape(value))
          $receiver.append_pdl1vj$(quote(value));
        else
  ...
  HeadersBuilder.prototype.validateName_61zpoe$ = function (name) {
    StringValuesBuilder.prototype.validateName_61zpoe$.call(this, name);
    HttpHeaders_getInstance().checkHeaderName_61zpoe$(name);
  };
  HeadersBuilder.prototype.validateValue_61zpoe$ = function (value) {
    StringValuesBuilder.prototype.validateValue_61zpoe$.call(this, value);
  ...
  function parseHeaderValueParameterValueQuoted(value, start) {
    ...
    loop: while (position <= get_lastIndex(value)) {
      ...
      else if (currentChar === 92 && position < (get_lastIndex(value) - 2 | 0)) {
  ...
  function URLBuilder(protocol, host, port, user, password, encodedPath, parameters, fragment, trailingQuery) {
    ...
    var tmp$;
    if ((tmp$ = get_originHost(URLBuilder$Companion_getInstance())) != null) {
      takeFrom(this, tmp$);
  ...
  URLBuilder.prototype.appendTo_0 = function (out) {
    ...
    switch (this.protocol.name) {
      case 'file':
        appendFile(out, this.host, this.encodedPath);
        return out;
      case 'mailto':
        appendMailto(out, get_userAndPassword_0(this), this.encodedPath);
        return out;
    }
    out.append_gw00v9$('://');
    out.append_gw00v9$(get_authority_0(this));
    appendUrlFullPath_0(out, this.encodedPath, this.parameters, this.trailingQuery);
  ...
  Object.defineProperty(Url.prototype, 'port', {configurable: true, get: function () {
    var tmp$;
  ...
  Url.prototype.toString = function () {
    ...
    builderAction$break: do {
      var tmp$;
      $receiver.append_pdl1vj$(this.protocol.name);
      switch (this.protocol.name) {
        case 'file':
        ...
        case 'mailto':
          ...
          if ((tmp$ = this.user) != null)
            ...
            throw IllegalStateException_init("User can't be empty.".toString());
          }

          var userValue = tmp$_0;
          appendMailto($receiver, userValue, this.host);
          break builderAction$break;
      }
      $receiver.append_pdl1vj$('://');
      $receiver.append_pdl1vj$(get_authority(this));
      $receiver.append_pdl1vj$(get_fullPath(this));
      if (this.fragment.length > 0) {
  ...
  function appendMailto($receiver, user, host) {
    ...
    $receiver.append_gw00v9$(encodeURLParameter(user));
  ...
  function get_userAndPassword($receiver) {
    var $receiver_0 = StringBuilder_init_0();
    appendUserAndPassword($receiver_0, $receiver.user, $receiver.password);
    return $receiver_0.toString();
  }
  ...
  function appendUserAndPassword($receiver, user, password) {
    if (user == null)
      return;
    $receiver.append_pdl1vj$(encodeURLParameter(user));
    if (password != null) {
      $receiver.append_s8itvh$(58);
      $receiver.append_pdl1vj$(encodeURLParameter(password));
    }$receiver.append_pdl1vj$('@');
  }
  function get_authority($receiver) {
    var $receiver_0 = StringBuilder_init_0();
    $receiver_0.append_pdl1vj$(get_userAndPassword($receiver));
    if ($receiver.specifiedPort === 0) {
  ...
  function get_authority_0($receiver) {
    var $receiver_0 = StringBuilder_init_0();
    $receiver_0.append_pdl1vj$(get_userAndPassword_0($receiver));
    $receiver_0.append_pdl1vj$($receiver.host);
  ...
  function takeFromUnsafe($receiver, urlString) {
    ...
    indexOfFirst$break: do {
      ...
      tmp$_2 = get_indices(urlString);
      tmp$_0_0 = tmp$_2.first;
      tmp$_1_0 = tmp$_2.last;
      tmp$_2_0 = tmp$_2.step;
    ...
    indexOfLast$break: do {
      var tmp$_3;
      tmp$_3 = reversed(get_indices(urlString)).iterator();
      while (tmp$_3.hasNext()) {
  ...
  function parseFile($receiver, urlString, startIndex, endIndex, slashCount) {
    switch (slashCount) {
      case 2:
        ...
        $receiver.encodedPath = urlString.substring(nextSlash, endIndex);
        break;
      case 3:
        $receiver.host = '';
        $receiver.encodedPath = '/' + urlString.substring(startIndex, endIndex);
        break;
      default:throw IllegalArgumentException_init('Invalid file url: ' + urlString);
    }
  }
  ...
  function parseQuery$lambda(this$parseQuery) {
    return function (key, values) {
      this$parseQuery.parameters.appendAll_poujtz$(key, values);
      return Unit;
    };
  }
  function parseQuery($receiver, urlString, startIndex, endIndex) {
    ...
    var rawParameters = parseQueryString(urlString.substring(startIndex_0, fragmentStart));
  ...
  function TextContent(text, contentType, status) {
    ...
    var tmp$, tmp$_0;
    tmp$_0 = this.text;
    this.bytes_0 = encodeToByteArray(((tmp$ = charset(this.contentType)) != null ? tmp$ : charsets.Charsets.UTF_8).newEncoder(), tmp$_0, 0, tmp$_0.length);
  }
  ...
  $$importsForInline$$['ktor-ktor-utils-jsLegacy'] = $module$ktor_ktor_utils_jsLegacy;
  ...
  package$http.get_userAndPassword_yq0j0v$ = get_userAndPassword;
  package$http.get_userAndPassword_a0yvw4$ = get_userAndPassword_0;
  package$http.get_authority_5y8s0c$ = get_authority;
  package$http.get_authority_3q1sfd$ = get_authority_0;
  ...
  package$http.appendUrlFullPath_th0jrq$ = appendUrlFullPath_0;
  ...
  package$http.get_originHost_n7qgwa$ = get_originHost;
  ...
  LETTERS_AND_NUMBERS = plus_1(plus_1(toSet(new CharRange(97, 122)), toSet(new CharRange(65, 90))), toSet(new CharRange(48, 57)));
  TOKENS = plus_1(setOf([toBoxedChar(33), toBoxedChar(35), toBoxedChar(37), toBoxedChar(38), toBoxedChar(39), toBoxedChar(42), toBoxedChar(43), toBoxedChar(45), toBoxedChar(46), toBoxedChar(94), toBoxedChar(95), toBoxedChar(96), toBoxedChar(124), toBoxedChar(126)]), LETTERS_AND_NUMBERS);
...
//# sourceMappingURL=ktor-ktor-http-jsLegacy.js.map

(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'ktor-ktor-http-jsLegacy', 'ktor-ktor-io-jsLegacy', 'kotlinx-serialization-kotlinx-serialization-core-jsLegacy', 'kotlinx-serialization-kotlinx-serialization-json-jsLegacy', 'ktor-ktor-client-json-jsLegacy'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('ktor-ktor-http-jsLegacy'), require('ktor-ktor-io-jsLegacy'), require('kotlinx-serialization-kotlinx-serialization-core-jsLegacy'), require('kotlinx-serialization-kotlinx-serialization-json-jsLegacy'), require('ktor-ktor-client-json-jsLegacy'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-serialization-jsLegacy'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'ktor-ktor-client-serialization-jsLegacy'.");
    }if (typeof this['ktor-ktor-http-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-serialization-jsLegacy'. Its dependency 'ktor-ktor-http-jsLegacy' was not found. Please, check whether 'ktor-ktor-http-jsLegacy' is loaded prior to 'ktor-ktor-client-serialization-jsLegacy'.");
    }if (typeof this['ktor-ktor-io-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-serialization-jsLegacy'. Its dependency 'ktor-ktor-io-jsLegacy' was not found. Please, check whether 'ktor-ktor-io-jsLegacy' is loaded prior to 'ktor-ktor-client-serialization-jsLegacy'.");
    }if (typeof this['kotlinx-serialization-kotlinx-serialization-core-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-serialization-jsLegacy'. Its dependency 'kotlinx-serialization-kotlinx-serialization-core-jsLegacy' was not found. Please, check whether 'kotlinx-serialization-kotlinx-serialization-core-jsLegacy' is loaded prior to 'ktor-ktor-client-serialization-jsLegacy'.");
    }if (typeof this['kotlinx-serialization-kotlinx-serialization-json-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-serialization-jsLegacy'. Its dependency 'kotlinx-serialization-kotlinx-serialization-json-jsLegacy' was not found. Please, check whether 'kotlinx-serialization-kotlinx-serialization-json-jsLegacy' is loaded prior to 'ktor-ktor-client-serialization-jsLegacy'.");
    }if (typeof this['ktor-ktor-client-json-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-serialization-jsLegacy'. Its dependency 'ktor-ktor-client-json-jsLegacy' was not found. Please, check whether 'ktor-ktor-client-json-jsLegacy' is loaded prior to 'ktor-ktor-client-serialization-jsLegacy'.");
    }root['ktor-ktor-client-serialization-jsLegacy'] = factory(typeof this['ktor-ktor-client-serialization-jsLegacy'] === 'undefined' ? {} : this['ktor-ktor-client-serialization-jsLegacy'], kotlin, this['ktor-ktor-http-jsLegacy'], this['ktor-ktor-io-jsLegacy'], this['kotlinx-serialization-kotlinx-serialization-core-jsLegacy'], this['kotlinx-serialization-kotlinx-serialization-json-jsLegacy'], this['ktor-ktor-client-json-jsLegacy']);
  }
}(this, function (_, Kotlin, $module$ktor_ktor_http_jsLegacy, $module$ktor_ktor_io_jsLegacy, $module$kotlinx_serialization_kotlinx_serialization_core_jsLegacy, $module$kotlinx_serialization_kotlinx_serialization_json_jsLegacy, $module$ktor_ktor_client_json_jsLegacy) {
  'use strict';
  ...
  var serializer_0 = $module$kotlinx_serialization_kotlinx_serialization_core_jsLegacy.kotlinx.serialization.serializer_1yb8b7$;
  var ensureNotNull = Kotlin.ensureNotNull;
  var Unit = Kotlin.kotlin.Unit;
  var Json = $module$kotlinx_serialization_kotlinx_serialization_json_jsLegacy.kotlinx.serialization.json.Json_x26noe$;
  var Kind_OBJECT = Kotlin.Kind.OBJECT;
  var Kind_CLASS = Kotlin.Kind.CLASS;
  var JsonSerializer = $module$ktor_ktor_client_json_jsLegacy.io.ktor.client.features.json.JsonSerializer;
  ...
  var serializer_1 = $module$kotlinx_serialization_kotlinx_serialization_core_jsLegacy.kotlinx.serialization.builtins.serializer_6eet4j$;
  var SetSerializer = $module$kotlinx_serialization_kotlinx_serialization_core_jsLegacy.kotlinx.serialization.builtins.SetSerializer_swdriu$;
  ...
  var get_nullable = $module$kotlinx_serialization_kotlinx_serialization_core_jsLegacy.kotlinx.serialization.builtins.get_nullable_2418p6$;
  ...
  var json = $module$ktor_ktor_client_json_jsLegacy.io.ktor.client.features.json;
  ...
  KotlinxSerializer.prototype.read_2ktxo1$ = function (type, body) {
    ...
    var deserializationStrategy = this.json_0.serializersModule.getContextual_lmshww$(type.type);
  ...
  function buildSerializer(value, module_0) {
    ...
    if (Kotlin.isType(value, JsonElement))
      ...
      tmp$_2 = (tmp$_1 = module_0.getContextual_lmshww$(Kotlin.getKClassFromExpression(value))) != null ? tmp$_1 : serializer_0(Kotlin.getKClassFromExpression(value));
    }
  ...
  SerializerInitializer.$metadata$ = {kind: Kind_OBJECT, simpleName: 'SerializerInitializer', interfaces: []};
  ...
  Object.defineProperty(_, 'SerializerInitializer', {get: SerializerInitializer_getInstance});
...
//# sourceMappingURL=ktor-ktor-client-serialization-jsLegacy.js.map

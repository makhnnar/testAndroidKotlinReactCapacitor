(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'kotlinx-coroutines-core', 'ktor-ktor-utils-jsLegacy', 'ktor-ktor-io-jsLegacy', 'ktor-ktor-http-jsLegacy', 'ktor-ktor-http-cio-jsLegacy'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('kotlinx-coroutines-core'), require('ktor-ktor-utils-jsLegacy'), require('ktor-ktor-io-jsLegacy'), require('ktor-ktor-http-jsLegacy'), require('ktor-ktor-http-cio-jsLegacy'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-core-jsLegacy'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'ktor-ktor-client-core-jsLegacy'.");
    }if (typeof this['kotlinx-coroutines-core'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-core-jsLegacy'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'ktor-ktor-client-core-jsLegacy'.");
    }if (typeof this['ktor-ktor-utils-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-core-jsLegacy'. Its dependency 'ktor-ktor-utils-jsLegacy' was not found. Please, check whether 'ktor-ktor-utils-jsLegacy' is loaded prior to 'ktor-ktor-client-core-jsLegacy'.");
    }if (typeof this['ktor-ktor-io-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-core-jsLegacy'. Its dependency 'ktor-ktor-io-jsLegacy' was not found. Please, check whether 'ktor-ktor-io-jsLegacy' is loaded prior to 'ktor-ktor-client-core-jsLegacy'.");
    }if (false) {
    }if (typeof this['ktor-ktor-http-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-core-jsLegacy'. Its dependency 'ktor-ktor-http-jsLegacy' was not found. Please, check whether 'ktor-ktor-http-jsLegacy' is loaded prior to 'ktor-ktor-client-core-jsLegacy'.");
    }if (typeof this['ktor-ktor-http-cio-jsLegacy'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-core-jsLegacy'. Its dependency 'ktor-ktor-http-cio-jsLegacy' was not found. Please, check whether 'ktor-ktor-http-cio-jsLegacy' is loaded prior to 'ktor-ktor-client-core-jsLegacy'.");
    }root['ktor-ktor-client-core-jsLegacy'] = factory(typeof this['ktor-ktor-client-core-jsLegacy'] === 'undefined' ? {} : this['ktor-ktor-client-core-jsLegacy'], kotlin, this['kotlinx-coroutines-core'], this['ktor-ktor-utils-jsLegacy'], this['ktor-ktor-io-jsLegacy'], this['ktor-ktor-http-jsLegacy'], this['ktor-ktor-http-cio-jsLegacy']);
  }
}(this, function (_, Kotlin, $module$kotlinx_coroutines_core, $module$ktor_ktor_utils_jsLegacy, $module$ktor_ktor_io_jsLegacy, $module$ktor_ktor_http_jsLegacy, $module$ktor_ktor_http_cio_jsLegacy) {
  'use strict';
  ...
  var Closeable = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.Closeable;
  var Job_0 = $module$kotlinx_coroutines_core.kotlinx.coroutines.Job_5dx9e$;
  var Attributes = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.AttributesJsFn;
  var ChildJob = $module$kotlinx_coroutines_core.kotlinx.coroutines.ChildJob;
  ...
  var Any = Object;
  var util = $module$ktor_ktor_utils_jsLegacy.io.ktor.util;
  ...
  var threadLocal = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.concurrent.threadLocal_issdgt$;
  ...
  var flattenEntries = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.flattenEntries_vr6bp2$;
  var joinToString = Kotlin.kotlin.collections.joinToString_fmv235$;
  var trimMargin = Kotlin.kotlin.text.trimMargin_rjktp$;
  var UnsupportedOperationException = Kotlin.kotlin.UnsupportedOperationException;
  var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
  var getKClass = Kotlin.getKClass;
  var toByteArray = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.toByteArray_3dmw3p$;
  var ByteReadChannel_0 = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.ByteReadChannel_fqrh44$;
  var readRemaining = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.readRemaining_3dmw3p$;
  var readBytes = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.readBytes_xc9h3n$;
  ...
  var TextContent = $module$ktor_ktor_http_jsLegacy.io.ktor.http.content.TextContent;
  ...
  var cancel_0 = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.cancel_3dmw3p$;
  var kotlin = Kotlin.kotlin;
  var toInt = Kotlin.kotlin.text.toInt_pdl1vz$;
  var PrimitiveClasses$intClass = Kotlin.kotlin.reflect.js.internal.PrimitiveClasses.intClass;
  var ByteReadPacket = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.ByteReadPacket;
  var Input = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.Input;
  var PrimitiveClasses$byteArrayClass = Kotlin.kotlin.reflect.js.internal.PrimitiveClasses.byteArrayClass;
  var copyTo = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.copyTo_47ygvz$;
  ...
  var PipelinePhase = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.pipeline.PipelinePhase;
  ...
  var withCharset = $module$ktor_ktor_http_jsLegacy.io.ktor.http.withCharset_73qf4i$;
  var readText = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.readText_1lnizf$;
  var get_name = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.charsets.get_name_2sg7fd$;
  ...
  var get_authority = $module$ktor_ktor_http_jsLegacy.io.ktor.http.get_authority_5y8s0c$;
  var takeFrom = $module$ktor_ktor_http_jsLegacy.io.ktor.http.takeFrom_jl1sg7$;
  var get_authority_0 = $module$ktor_ktor_http_jsLegacy.io.ktor.http.get_authority_3q1sfd$;
  ...
  var HeaderValue = $module$ktor_ktor_http_jsLegacy.io.ktor.http.HeaderValue;
  var OutgoingContent$NoContent = $module$ktor_ktor_http_jsLegacy.io.ktor.http.content.OutgoingContent.NoContent;
  ...
  var parseHeaderValue = $module$ktor_ktor_http_jsLegacy.io.ktor.http.parseHeaderValue_pdl1vj$;
  var HeadersBuilder_init = $module$ktor_ktor_http_jsLegacy.io.ktor.http.HeadersBuilder;
  var ConcurrentMap = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.collections.ConcurrentMap;
  var removeAll = Kotlin.kotlin.collections.removeAll_qafx1e$;
  var URLBuilder = $module$ktor_ktor_http_jsLegacy.io.ktor.http.URLBuilder;
  var toList_0 = Kotlin.kotlin.collections.toList_7wnvza$;
  var ArrayList_init_0 = Kotlin.kotlin.collections.ArrayList_init_ww73n8$;
  var toLowerCasePreservingASCIIRules = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.toLowerCasePreservingASCIIRules_pdl1vz$;
  ...
  var HttpMessage = $module$ktor_ktor_http_jsLegacy.io.ktor.http.HttpMessage;
  var takeFrom_0 = $module$ktor_ktor_http_jsLegacy.io.ktor.http.takeFrom_rs9g2p$;
  var appendAll = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.appendAll_k10e8h$;
  var SupervisorJob = $module$kotlinx_coroutines_core.kotlinx.coroutines.SupervisorJob_5dx9e$;
  var HttpMessageBuilder = $module$ktor_ktor_http_jsLegacy.io.ktor.http.HttpMessageBuilder;
  var takeFrom_1 = $module$ktor_ktor_http_jsLegacy.io.ktor.http.takeFrom_wol2ee$;
  var formUrlEncode = $module$ktor_ktor_http_jsLegacy.io.ktor.http.formUrlEncode_invt95$;
  var writeFully = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.writeFully_4scpqu$;
  var close_0 = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.close_x5qia6$;
  ...
  var writeFully_0 = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.writeFully_i6snlg$;
  var PartData$FileItem = $module$ktor_ktor_http_jsLegacy.io.ktor.http.content.PartData.FileItem;
  var PartData$BinaryItem = $module$ktor_ktor_http_jsLegacy.io.ktor.http.content.PartData.BinaryItem;
  var PartData$FormItem = $module$ktor_ktor_http_jsLegacy.io.ktor.http.content.PartData.FormItem;
  var Random = Kotlin.kotlin.random.Random;
  var toString_0 = Kotlin.kotlin.text.toString_dqglrj$;
  var take = Kotlin.kotlin.text.take_6ic1pp$;
  var readAvailable = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.readAvailable_czhrh1$;
  var encodeToByteArray = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.charsets.encodeToByteArray_fj4osb$;
  var collectionSizeOrDefault = Kotlin.kotlin.collections.collectionSizeOrDefault_ba2ldo$;
  var requestWriteBuffer = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.requestWriteBuffer_9tm6dw$;
  var Buffer = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.Buffer;
  var completeWriting = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.completeWriting_oczduq$;
  var Parameters = $module$ktor_ktor_http_jsLegacy.io.ktor.http.Parameters;
  var Headers = $module$ktor_ktor_http_jsLegacy.io.ktor.http.Headers;
  var copyToArray = Kotlin.kotlin.collections.copyToArray;
  var decode = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.charsets.decode_lb8wo3$;
  var OutgoingContent$ProtocolUpgrade = $module$ktor_ktor_http_jsLegacy.io.ktor.http.content.OutgoingContent.ProtocolUpgrade;
  var ConcurrentList = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.collections.ConcurrentList;
  ...
  var readShort = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.readShort_7wsnj1$;
  ...
  defineInlineFunction('ktor-ktor-client-core-jsLegacy.io.ktor.client.call.receive_8ov3cv$', wrapFunction(function () {
    ...
    return function (T_0, isT, $receiver, continuation) {
      ...
      typeInfo$break: do {
       ...
       while (false);
      Kotlin.suspendCall($receiver.receive_jo9acv$(typeInfo$result_0, Kotlin.coroutineReceiver()));
  ...
  Coroutine$getResponseContent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Object.defineProperty(SavedHttpRequest.prototype, 'attributes', {get: function () {
    return this.$delegate_k8mkjd$_0.attributes;
  }});
  Object.defineProperty(SavedHttpRequest.prototype, 'content', {get: function () {
    return this.$delegate_k8mkjd$_0.content;
  }});
  Object.defineProperty(SavedHttpRequest.prototype, 'coroutineContext', {get: function () {
    return this.$delegate_k8mkjd$_0.coroutineContext;
  }});
  Object.defineProperty(SavedHttpRequest.prototype, 'executionContext', {get: function () {
    return this.$delegate_k8mkjd$_0.executionContext;
  }});
  Object.defineProperty(SavedHttpRequest.prototype, 'headers', {get: function () {
    return this.$delegate_k8mkjd$_0.headers;
  }});
  Object.defineProperty(SavedHttpRequest.prototype, 'method', {get: function () {
    return this.$delegate_k8mkjd$_0.method;
  }});
  Object.defineProperty(SavedHttpRequest.prototype, 'url', {get: function () {
  ...
  UnsupportedUpgradeProtocolException.$metadata$ = {kind: Kind_CLASS, simpleName: 'UnsupportedUpgradeProtocolException', interfaces: [IllegalArgumentException]};
      ...
      try {
        switch (this.state_0) {
          ...
          case 1:
            throw this.exception_0;
          case 2:
            return this.local$closure$executionContext.cancel_m4sck1$(new HttpRequestTimeoutException(this.local$this$.context)), Unit;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      } catch (e) {
  ...
  function HttpRequestTimeoutException(request) {
    var tmp$, tmp$_0;
    CancellationException_init('Request timeout has been expired [url=' + request.url.buildString() + ', request_timeout=' + ((tmp$_0 = (tmp$ = request.getCapabilityOrNull_i25mbv$(HttpTimeout$Feature_getInstance())) != null ? tmp$.requestTimeoutMillis : null) != null ? tmp$_0 : 'unknown').toString() + ' ms]', this);
  ...
  defineInlineFunction('ktor-ktor-client-core-jsLegacy.io.ktor.client.request.get_ixrg4t$', wrapFunction(function () {
    var HttpMethod = _.$$importsForInline$$['ktor-ktor-http-jsLegacy'].io.ktor.http.HttpMethod;
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
    var HttpStatement_init = _.io.ktor.client.statement.HttpStatement;
    var getKClass = Kotlin.getKClass;
    var throwCCE = Kotlin.throwCCE;
  ...
  defineInlineFunction('ktor-ktor-client-core-jsLegacy.io.ktor.client.request.get_hf8dw$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    var takeFrom = _.$$importsForInline$$['ktor-ktor-http-jsLegacy'].io.ktor.http.takeFrom_jl1sg7$;
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
    var utils = _.io.ktor.client.utils;
    var url = _.io.ktor.client.request.url_3rzbk2$;
    var HttpMethod = _.$$importsForInline$$['ktor-ktor-http-jsLegacy'].io.ktor.http.HttpMethod;
  ...
  defineInlineFunction('ktor-ktor-client-core-jsLegacy.io.ktor.client.request.get_2swosf$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    var takeFrom = _.$$importsForInline$$['ktor-ktor-http-jsLegacy'].io.ktor.http.takeFrom_wol2ee$;
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
    var utils = _.io.ktor.client.utils;
    var url = _.io.ktor.client.request.url_3rzbk2$;
    var HttpMethod = _.$$importsForInline$$['ktor-ktor-http-jsLegacy'].io.ktor.http.HttpMethod;
  ...
  defineInlineFunction('ktor-ktor-client-core-jsLegacy.io.ktor.client.request.forms.submitForm_k24olv$', wrapFunction(function () {
    var Parameters = _.$$importsForInline$$['ktor-ktor-http-jsLegacy'].io.ktor.http.Parameters;
    var Unit = Kotlin.kotlin.Unit;
    var HttpMethod = _.$$importsForInline$$['ktor-ktor-http-jsLegacy'].io.ktor.http.HttpMethod;
  ...
  DefaultHttpResponse.$metadata$ = {kind: Kind_CLASS, simpleName: 'DefaultHttpResponse', interfaces: [HttpResponse_0]};
        ...
        switch (this.state_0) {
          ...
          case 1:
            ...
            typeInfo$break: do {
             ...
             while (false);
            this.state_0 = 2;
            this.result_0 = tmp$_2.receive_jo9acv$(typeInfo$result_0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 2:
...
//# sourceMappingURL=ktor-ktor-client-core-jsLegacy.js.map
